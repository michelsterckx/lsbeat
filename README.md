...
`${GOPATH}/github.com/michelsterckx`
...
```
git remote set-url origin https://github.com/michelsterckx/lsbeat
...
```
mkdir -p ${GOPATH}/github.com/michelsterckx
cd ${GOPATH}/github.com/michelsterckx
git clone https://github.com/michelsterckx/lsbeat
```
